                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody id="datalist">
                                        ...
                                        $varCnt=0;
                                        $sql="select * from members order by id_usr desc";
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label for="kategorikode" class="form-control-label">User:</label>
                                            ...
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="kategorikode" class="form-control-label">Password:</label>
