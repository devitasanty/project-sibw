<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-
2 mb-3 border-bottom">
<h1 class="h2">Payment Validation</h1>
</div>
<div class="col-lg-8">
...
?>
    ...
    <td style="text-align: right;white-space: nowrap"><?php echo number_format($varTot, 2);?></td> 
...
<h5 class="modal-title" id="ModalLabel01"> Konfirmasi </h5>
...
<div class="modal-body" style="background-color:#BBD6EC;">
    <p style="color: blue; font-size: larger;text-align: center">Yakin Validasi data berikut...?</p>
...
<div class="modal-header" style="background-color: #d9534f;">
    <h5 class="modal-title" id="ModalLabel01"> Delete </h5>
    <button class="close" type="button" data-dismiss="modal" aria-label="close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
...
<!-- Modal Error Aksi -->
<div class="modal fade" id="ModalError" tabindex="-1" role="dialog" aria- labelledby="DialogModalLabel"
aria-hidden="true">
<div class="modal-dialog modal-lg" role="document">
<div class="modal-content">
<div class="modal-header" style="background-color: #d9534f;">
<h5 class="modal-title" id="ModalLabel01"> ERROR...!!! </h5>
<button class="close" type="button" data-dismiss="modal" aria-label="close">
    <span aria-hidden="true">&times;</span>
</button> 
</div>
