                ...
                <div class="row">
                    <div class="table-responsive">
                        ...
                        <div class="hero-unit">
                            ...
                            if ($_POST['finish']) {
                                session_destroy();
                                echo 'Terima kasih Anda sudah berbelanja di BookStore dan berikut ini adalah data yang perlu Anda catat.';
                                echo '<p>Total biaya untuk pembelian Produk adalah Rp. ' . $_POST['total'] . ',- dan biaya bisa di kirimkan melalui Rekening Bank BRI cabang Ngawi dengan nomor rekening 123-234-56347-8 atas nama BookStore.</p>';
